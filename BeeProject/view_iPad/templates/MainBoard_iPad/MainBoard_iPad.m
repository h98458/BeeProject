...
#pragma mark - MainBoard_iPad

@interface MainBoard_iPad()
{

}
@end

@implementation MainBoard_iPad
DEF_SINGLETON( MainBoard_iPad )
...
{
    [bee.ui.appBoard_iPad showTabbar];
...
#pragma mark - self
ON_SIGNAL2( MainBoard_iPad , signal )
{
